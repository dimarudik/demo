create or replace view bi as
SELECT nspname AS schemaname, tblname, idxname, bs*(relpages)::bigint AS real_size,
  bs*(relpages-est_pages)::bigint AS extra_size,
  round(100 * (relpages-est_pages)::numeric / relpages, 3) AS extra_pct,
  fillfactor,
  CASE WHEN relpages > est_pages_ff
    THEN bs*(relpages-est_pages_ff)
    ELSE 0
  END AS bloat_size,
  round(100 * (relpages-est_pages_ff)::numeric / relpages, 3) AS bloat_pct,
  is_na
FROM (
  SELECT coalesce(1 +
